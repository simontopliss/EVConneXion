...
enum Symbols {
    ...
    static let yesName                       = "checkmark.circle"
    static let yesSymbol                     = Image(systemName: yesName)
    static let noName                        = "xmark.circle"
    static let noSymbol                      = Image(systemName: noName)
    ...
    static let chargerSearchSymbolName       = "ev.charger"
    static let chargerSearchSymbol           = Image(systemName: chargerSearchSymbolName)
